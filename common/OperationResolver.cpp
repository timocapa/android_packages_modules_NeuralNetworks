...
const OperationRegistration* register_MIRROR_PAD();
...
const OperationRegistration* register_REVERSE();
...
BuiltinOperationResolver::BuiltinOperationResolver() {
    ...
    registerOperation(register_MIRROR_PAD());
    ...
    registerOperation(register_REVERSE());
